...
if (isset($_POST['compra'])) {
    ...
    $mensagem = $util->tirarAcento($mensagem);
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 text-center text-lg-right" style="margin-top: 25px;">
                        ...
                        <h3 class=" text-white" style="font-weight: 600; font-size: 42pt;"><label for="" class="text-warning"><?php echo strtoupper($Carro[0]->MARDESCRICAO); ?></label> <?php echo " " . strtoupper($Carro[0]->MODDESCRICAO) ?></h3>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="text-warning text-center display-5 text-lg-right" style="font-weight: 600"><?php echo "R$ " . FormatarMoeda(strtoupper($Carro[0]->CARPRECO)); ?></h1>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid bg-dark" style="padding: 20px; border-radius: 5px; ">
                ...
                <div class="row" style="margin-top: 5px;">
                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        ...
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo strtoupper($Carro[0]->CARANO); ?></label>
                    </div>

                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        <label for="" style="font-size: 10pt; margin:0px; padding:0px;">KM</label>
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo FormatarValorDecimal(strtoupper($Carro[0]->CARKM)); ?></label>
                    </div>

                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        <label for="" style="font-size: 10pt; margin:0px; padding:0px;">Câmbio</label>
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo strtoupper($Carro[0]->CAMDESCRICAO); ?></label>
                    </div>

                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        <label for="" style="font-size: 10pt; margin:0px; padding:0px;">Carroceria</label>
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo strtoupper($Carro[0]->CRCDESCRICAO); ?></label>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 5px;">
                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        ...
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo strtoupper($Carro[0]->CARPORTAS); ?></label>
                    </div>

                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        <label for="" style="font-size: 10pt; margin:0px; padding:0px;">Combustivel</label>
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo strtoupper($Carro[0]->COMDESCRICAO); ?></label>
                    </div>

                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        <label for="" style="font-size: 10pt; margin:0px; padding:0px;">Cor</label>
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo strtoupper($Carro[0]->CORDESCRICAO); ?></label>
                    </div>

                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        <label for="" style="font-size: 10pt; margin:0px; padding:0px;">Motor</label>
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo strtoupper($Carro[0]->MOTPOTENCIA); ?></label>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 5px;">
                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        ...
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo strtoupper($Carro[0]->CARVALVULAS); ?></label>
                    </div>

                    <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;">
                        <label for="" style="font-size: 10pt; margin:0px; padding:0px;">Localização</label>
                        <br />
                        <label for="" style="font-size: 15pt;"><?php echo strtoupper($Carro[0]->LOCALIZACAO); ?></label>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row" style="margin-top: 15px;">
                        <?php foreach ($Detcarro as $d) { ?>
                            <div class="col-lg-3 col-xs-6 text-warning text-center text-lg-left" style="font-weight: 600;margin-top: 15px;">
                                <label for="" style="font-size: 12pt;"><?php echo strtoupper($d['COMPDESC']); ?></label>
                            </div>
                        <?php } ?>
                    </div>
                </div>
                            ...
                            foreach ($files as $f) {
                                if ($f != '.' && $f != '..') { ?>
                                    <a class="col-lg-2" href="<?php echo $dir . '/' . $f; ?>" style="margin-top: 25px;">
                                        <img class="card-img-top" style="width: 100%; border-radius: 2px;" src="<?php echo $dir . '/' . $f; ?>" title="<?php echo  $f; ?>" alt="<?php echo $f; ?>">
                                    </a>
                            <?php
                                }
                            }
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 text-center">
                    <img class="img-thumbnail" src="assets/img/Carros/<?php echo $Carro[0]->CARFOTO; ?>" width="300px" alt="Capa do Anuncio">
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 5px; padding:5px;">
                <div class="col-12 text-center">
                    ...
                    <h3 class=" text-white" style="font-weight: 600; font-size: 20pt;"><label for="" class="text-warning"><?php echo strtoupper($Carro[0]->MARDESCRICAO); ?></label> <?php echo " " . strtoupper($Carro[0]->MODDESCRICAO) ?></h3>
                    <h4 class="display-6 text-warning"><?php echo $Carro[0]->VERNOME; ?></h4>
                </div>
            </div>
    ...
    <div class="row bg-dark" style="margin-top: 5px; padding: 5px;">
        <div class="col-lg-12">
            <div class="container-fluid">
                ...
                <?php if ($codCarro) { ?>
                    <div id="galleryMobille" class="row">
                        <?php
                        $dir = 'assets/img/Carros/' . $codCarro;
                        if (!is_dir($dir)) {
                            mkdir($dir);
                        ...
                        if (count($files) > 2) {
                            foreach ($files as $f) {
                                if ($f != '.' && $f != '..') { ?>
                                    <a class="col-4" href="<?php echo $dir . '/' . $f; ?>" style="margin-top: 15px;margin-bottom: 10px">
                                        <img class="card-img-top" style="width: 100%; border-radius: 2px;" src="<?php echo $dir . '/' . $f; ?>" title="<?php echo  $f; ?>" alt="<?php echo $f; ?>">
                                    </a>
                            <?php
                                }
    ...
    <div class="row" style="margin-top: 5px; padding:5px;">
        <section class="col-lg-8" style="padding: 5px;">
            ...
            <div class="container-fluid bg-dark" style="padding: 20px; border-radius: 5px; ">
                ...
                <div class="row" style="margin-top: 5px; border-top: 1px solid #e9c916; border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Codigo</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo strtoupper($Carro[0]->CARCOD); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px; border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;">Ano/Modelo</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo strtoupper($Carro[0]->CARANO); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px;  border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Quilometragem</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo FormatarValorInteiro(strtoupper($Carro[0]->CARKM)); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px;  border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Cambio</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo strtoupper($Carro[0]->CAMDESCRICAO); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px;  border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Carroceria</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo strtoupper($Carro[0]->CRCDESCRICAO); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px;  border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Portas</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo strtoupper($Carro[0]->CARPORTAS); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px;  border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Combustivel</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo strtoupper($Carro[0]->COMDESCRICAO); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px;  border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Cor</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo strtoupper($Carro[0]->CORDESCRICAO); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px;  border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Motor</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo strtoupper($Carro[0]->MOTPOTENCIA); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px;  border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Valvulas</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 12pt;"><?php echo strtoupper($Carro[0]->CARVALVULAS); ?></label>
                    </div>
                </div>
                <div class="row" style="margin-top: 5px;  border-bottom: 1px solid #e9c916">
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 15pt; margin:0px; padding:0px;"> Localização</label>
                    </div>
                    <div class="col-6 text-warning text-left" style="font-weight: 600;">
                        <label for="" style="font-size: 10pt;"><?php echo strtoupper($Carro[0]->LOCALIZACAO); ?></label>
                    </div>
                </div>
            </div>
            ...
            <?php if ($Detcarro) { ?>
                <div class="container-fluid bg-dark" style="padding: 20px; border-radius: 5px; margin-top: 10px;">
                    ...
                    <div class="row" style="margin-top: 15px; padding: 0px;">
                        <?php foreach ($Detcarro as $d) { ?>
                            <div class="col-6  text-warning text-left" style="font-weight: 600;margin-top: 15px;">
                                <label for="" style="font-size: 10pt;"><?php echo strtoupper($d['COMPDESC']); ?></label>
                            </div>
                        <?php } ?>
                    </div>
                </div>
