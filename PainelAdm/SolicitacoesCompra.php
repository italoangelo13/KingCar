...
<script>
    ...
    function BuscaDadosSolicitacao(codCarro, codSol){
        $.ajax({
            ...
            success: function(data) {
                ...
                if(dados.TransCod == 0){
                    ...
                    $('#_lblDtSolicitacao').text(dados.dataSolicitacao);
                ...
                $('#_gridPesq').DataTable({
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, row, meta) {
                                if (type === 'display') {
                                    data = '<a style="cursor:pointer;" href="DetSolicitacaoCompra.php?cod=' + data +'" class="btn btn-success"><i class="icone-login-1"></i></a>';
                                }
